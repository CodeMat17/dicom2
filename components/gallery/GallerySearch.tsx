  ...
  return (
    <div className="mb-12 sm:mb-14">
      <div className="relative mx-auto max-w-xl">
        <Search
          aria-hidden
          className="pointer-events-none absolute left-5 top-1/2 h-4 w-4 -translate-y-1/2 text-white/70"
        />
        ...
        <input
          ...
          className="w-full rounded-full border border-white/10 bg-white/[0.04] py-4 pl-12 pr-12 text-sm text-white placeholder:text-white/70 shadow-card outline-none transition-all duration-300 hover:border-white/20 focus:border-gold/50 focus:bg-white/[0.06] focus-visible:ring-2 focus-visible:ring-gold/40 [&::-webkit-search-cancel-button]:hidden"
        />
        ...
        {active && (
          <button
            ...
            className="absolute right-4 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full text-white/70 transition-colors duration-300 hover:bg-white/10 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-gold/70"
          >
            <X className="h-4 w-4" />
          </button>
        )}
      ...
      <p
        aria-live="polite"
        className="mt-3 text-center text-xs text-white/70 min-h-[1rem]"
      >
